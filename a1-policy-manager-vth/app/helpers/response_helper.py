...
def route_check(config=None, get_function=None, post_function=None, put_function=None, delete_function=None):
    ...
    valid_actions = {"policies", "policy", "policy_ids", "policy_schema", "policy_schemas", "policy_status", "policy_types", "ric", "rics", "service", "services", "keepalive", "status" }
    required_keys = {"action", "method", "auth", "action_data"}
